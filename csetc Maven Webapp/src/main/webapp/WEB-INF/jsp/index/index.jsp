                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li><a class="J_menuItem" href="SysUser/profile.do">个人资料</a>
                                </li>
                                ...
                                <li class="divider"></li>
                                <li><a href="SysUser/loginout.do">安全退出</a>
                                </li>
                            </ul>
                        </div>
                        <div class="logo-element">ICSS
                        </div>
                    </li>
                         		...
                         		<c:forEach items="${m.children }" var="c">
                         			<c:choose>
                         				<c:when test="${empty c.children }">
                         					<li>
				                                <a class="J_menuItem" href="${c.value }">${c.name }</a>
				                            </li>
                         				</c:when>
                         				<c:otherwise>
                         					<li>
				                                <a href="#">${c.name }<span class="fa arrow"></span></a>
				                                <ul class="nav nav-third-level">
				                                	<c:forEach items="${c.children }" var="t">
				                                		<li>
							                                <a class="J_menuItem" href="${t.value }">${t.name }</a>
							                            </li>
				                                	</c:forEach>
				                                </ul>
				                            </li>
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="content.do">首页</a>
                    </div>
                </nav>
                ...
                <a href="SysUser/loginout.do" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>

            <!-- content部分 -->
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<%=basePath%>SysUser/content.do" frameborder="0" data-id="content.do" seamless></iframe>
            </div>
            <!-- content部分// -->

            <div class="footer">
                <div class="pull-right">&copy; 2017 湖南中软计算机系统服务有限公司
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function(){
	    	if(menu == "" || menu.length == 0){
	    		//alert("您还没有被授权，请先让管理员授权后再登录");
	    		window.location.href="login.jsp"; 
	    	}
    	});
    	var passtype = <%=session.getAttribute("passtype") %>;
    	if(passtype != "0"){
			toastr.warning("您的密码是临时密码!请修改密码");
		}
    </script>
</body>
</html>
